...
function probeMessengerPanelActivityAndComputerIdentity() {
  return JSON.parse(runPwaRender(`
    ...
    import { BotSettings } from "./pwa/src/components/BotSettings.tsx";
    import { SelectedBotComputerPreview } from "./pwa/src/components/Computer.tsx";
    ...
    const previewElement = collectChildren(
      settingsTree,
      (node) => node.type === SelectedBotComputerPreview,
    )[0];
    const previewTree = SelectedBotComputerPreview(previewElement.props);
